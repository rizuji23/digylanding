...
<head>
    ...
    <title>List Admin | Digyhomeschooling</title>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <?php 
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM admin ORDER BY id DESC");
                $no = 1;
                foreach ($sql as $s){
            ...
            ?>
                <tr class="text-center">
                    ...
                    <td class="pt-4"><?php echo $s['nama_admin'] ?></td>
                    <td class="pt-4"><?php echo $s['username'] ?></td>
                    <td class="pt-4"><?php echo $s['tanggal_update'] ?></td>
                    <td>
                        <a href="editadmin.php?i=<?php echo $s['id'] ?>" class="btn btn-primary">Edit</a>
                        <a onClick="return confirm('Apakah ingin dihapus?')" href="hapusadmin.php?ih=<?php echo $s['id'] ?>" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
