...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
    ...
    <?php 
    $id = mysqli_real_escape_string($koneksi, htmlspecialchars($_GET['i']));
        if (isset($_POST['edit'])){
            editadmin($_POST, $id);
        }
    ...
    <div class="container mt-5">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <div class="input-admin-l">
                    <label for="">Nama Admin</label>
                </div>
                <div class="input-admin">
                    <input type="text" name="nama_admin" value="<?php echo $a['nama_admin'] ?>" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-admin">
                    <input type="text" name="username" value="<?php echo $a['username'] ?>" class="form-control" disabled>
                </div>
            </div>
