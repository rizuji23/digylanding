...
<head>
    ...
    <title>Isi Artikel | Digyhomeschooling</title>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-judul">
                <div class="form-group">
                    <input type="text" name="judul" placeholder="Tulis judul disini.." class="form-control input-judul" autofocus>
                </div>

                <div class="form-group">
                    <label for="">Tags</label>
                    <input type="text" name="tags" value="" name="tags" data-role="tagsinput" />
                    <small><span class="text-danger">*</span> Setelah mengisi tag klik enter.</small>
                </div>
            ...
            <div class="form-group mt-3">
                <input type="submit" class="btn btn-warning btn-orange btn-block" value="Simpan" name="simpan" />
            </div>
        </form>
    </div> 
